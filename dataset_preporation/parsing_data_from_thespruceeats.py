...
"""
Этап 2б
Граббинг данных с сайта https://www.thespruceeats.com, парсинг данных в единый формат, сохранение данных.
На основе верстки сайта скрипт собирает данные с общей страницы рецептов - сборка ссылок.
